...
-- It is intended either that you use and reuse existing tables, or none at all.

-- For example, rather than creating a new table for a random vector:

-- > local position = { vector.random() }
...
-- > end
-- >
-- > local position = repack3(vector.random())

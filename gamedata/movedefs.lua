...
---Given quadratic kinetic energies, we may have to use very high structure constants
-- to prevent small but fast-moving objects from gaining excessive crushing strength.
local CRUSH = {
	NONE    = 0,
	TINY    = 5,
	LIGHT   = 10,
	...
	HUGE    = 1400,
	MASSIVE = 9999,
	MAXIMUM = 99999, -- arbitrary limit to coefficient
}
local DEPTH = {
	NONE       = 0,
...
local SLOPE = {
	...
	MODERATE = 36,
	STEEP    = 50,
	EXTREME  = 80, -- ~cliffs but not walls
	MAXIMUM  = 255,
}
local SPEED_CLASS = {
	VEH   = 0,
